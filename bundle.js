...
let matches = {
    ...
    match27 : {
        goals1: [
            {name: "Eden Hazard", minute: 6},
            {name: "Romelu Lukaku", minute: 16},
            {name: "Romelu Lukaku", minute: 45},
            {name: "Eden Hazard", minute: 51},
            {name: "Michy Batshuayi ", minute: 90}
        ], 
        goals2: [
            {name: "Dylan Bronn", minute: 18},
            {name: "Wahbi Khazri", minute: 90}
        ]
    },
    match28 : {
        goals1: [
        ...
        goals2: [
            {name: "Carlos Vela", minute: 26},
            {name: "Javier Hernánde", minute: 66}
        ]
    },
    match29 : {
        goals1: [
            {name: "Marco Reus", minute: 48},
            {name: "Toni Kroos", minute: 90}
        ], 
        goals2: [
...
//control infoBox displaying on click on mobile device
countryElements.forEach(element => element.addEventListener('click', function() {
    if (window.innerWidth > 815) return;
    countryElements.forEach(item => {
        this !== item ? item.querySelector('.info').classList.remove('toggleDisplay') : this.querySelector('.info').classList.toggle('toggleDisplay');
    })
}));
...
const match60 = new Match(60, '2018-07-07', '21:00', null, null, null, null, 'Fisht Stadium', 'Sochi', 'UTC+3', null);
